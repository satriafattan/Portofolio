const Project = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Website informasi lembaga pendidikan Texas College Metro yang menyajikan profil, dan informasi akademik lengkap.',
    ...
    {
      id: 4,
      title: 'Peniliaian Informasi Publik',
      description: 'Sistem penilaian keterbukaan informasi publik untuk instansi pemerintah dengan fitur evaluasi, monitoring, dan pelaporan yang terintegrasi.',
      image: '/images/Projek%204.png',
      technologies: ['Laravel', 'Tailwind CSS', 'blade', 'PHP', 'MySQL', 'figma', 'Quality Asurance'],
      github: '',
      demo: '',
    },
    ...
    {
      id: 5,
      title: 'Web Desa Palas Aji',
      description: 'Website resmi Desa Palas Aji yang menyediakan informasi profil desa, layanan administrasi online, berita desa, dan sarana komunikasi antara pemerintah desa dengan masyarakat.',
      image: '/images/Projek%205.png',
      technologies: ['WordPress', 'Elementor', 'PHP', 'MySQL', 'figma', 'Quality Asurance'],
      github: '',
      demo: '',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 hover:border-gray-600 transition-all duration-300 group flex flex-col"
            >
              {/* Project Image */}
